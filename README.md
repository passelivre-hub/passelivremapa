...
2. Ative o GitHub Pages nas configurações do repositório, usando a raiz (`/`) como fonte (não use `/docs`).
3. Aguarde a publicação; acesse `https://<usuario>.github.io/<repositorio>/` e o `index.html` na raiz carregará os dados dos CSV/GeoJSON.
